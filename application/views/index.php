...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>speed.png">
    ...
    <!-- <link rel="stylesheet" href="<?php echo base_url();?>css/bootstrap-select.less"> -->
    <link rel="stylesheet" href="<?php echo base_url();?>scss/style.css">
    <link href="<?php echo base_url();?>css/lib/vector-map/jqvmap.min.css" rel="stylesheet">

    <link href='<?php echo base_url();?>css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Acident</a>
                    </li>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><a href="#">การวิเคราะห์ปัจจัยที่ส่งผลต่อการเกิดอุบัติเหตุของนักศึกษาทางรถจักยานยนต์</a></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
    ...
    <script src="<?php echo base_url();?>ajax/libs/popper.js/1.12.3/umd/popper.min.js"></script>
    <script src="<?php echo base_url();?>js/plugins.js"></script>
    <script src="<?php echo base_url();?>js/main.js"></script>


    <script src="<?php echo base_url();?>js/lib/chart-js/Chart.bundle.js"></script>
    <script src="<?php echo base_url();?>js/dashboard.js"></script>
    <script src="<?php echo base_url();?>js/widgets.js"></script>
    <script src="<?php echo base_url();?>js/lib/vector-map/jquery.vmap.js"></script>
    <script src="<?php echo base_url();?>js/lib/vector-map/jquery.vmap.min.js"></script>
    <script src="<?php echo base_url();?>js/lib/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="<?php echo base_url();?>js/lib/vector-map/country/jquery.vmap.world.js"></script>
    <script>
        ( function ( $ ) {
            "use strict";
